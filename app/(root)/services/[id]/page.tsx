...
import FormForRegisteration from "@/components/forms/FormForRegisteration"; // Import your registration form
        ...
        <div className="flex flex-col-reverse xl:flex-row pt-10 gap-5">
          <div className="flex flex-1 flex-col justify-center md:px-10">
            ...
            <div className="flex flex-col items-center">
              ...
              {/* Add the Dialog with Register Button */}
              <Dialog >
                <DialogTrigger asChild>
                  <Button className="mt-6 bg-primary-color1 hover:bg-primary-hover w-[50%] h-[50px] rounded-[8px] text-lg tracking-wider ">
                    Register Now
                  </Button>
                </DialogTrigger>
