...
//   city: string;
//   country: string;
//   type_of_contract: "Permanent" | "Contract" | "Freelance" | "Internship";
...
const JobCard = ({ job }: { job: any }) => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg md:rounded-xl shadow-sm p-4 md:p-6 hover:shadow-md transition-all duration-300 border border-gray-100 dark:border-gray-700 flex flex-col h-full">
