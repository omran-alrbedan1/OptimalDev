  ...
  return (
    ...
    >
      ...
      >
        {items?.map((item, idx) => {
          const cardContent = (
            <div className="group relative flex flex-col items-center justify-center w-[280px] h-[200px] md:w-[320px] md:h-[220px]">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full p-8">
                  ...
                  <div className="text-center">
                    <h3 className="font-bold text-gray-900 dark:text-white text-lg md:text-xl leading-tight tracking-wide transition-all duration-500 group-hover:text-[#22ace3] group-hover:scale-105">
                      {item.name}
                      {item.link_url && (
                        <span className="ml-1 text-sm text-[#22ace3] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          ↗
                        </span>
                      )}
                    </h3>
